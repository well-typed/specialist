...
compareId (SpecialistNote cid1 _ _ _ _ _) (SpecialistNote cid2 _ _ _ _ _) =
    compare cid1 cid2

compareDictInfos :: SpecialistNote -> SpecialistNote -> Ordering
compareDictInfos (SpecialistNote _ _ dis1 _ _ _) (SpecialistNote _ _ dis2 _ _ _) =
    case (sequence dis1, sequence dis2) of
      (Nothing, Nothing) -> GT
      (dis1', dis2') -> compare dis1' dis2'

compareFunctionIpe :: SpecialistNote -> SpecialistNote -> Ordering
compareFunctionIpe (SpecialistNote _ _ _ fIpe1 _ _) (SpecialistNote _ _ _ fIpe2 _ _) =
    case (fIpe1, fIpe2) of
      (Nothing, Nothing) -> GT
      (fIpe1', fIpe2') -> compare fIpe1' fIpe2'

compareLocationLabel :: SpecialistNote -> SpecialistNote -> Ordering
compareLocationLabel (SpecialistNote _ _ _ _ l1 _) (SpecialistNote _ _ _ _ l2 _) =
    compare l1 l2
